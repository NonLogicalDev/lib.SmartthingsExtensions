...
metadata {
    ...
    preferences {
        ...
        section {
            ...
            getBoolInput("autoClearTamper", "Automatically Clear Tamper?\n(The tamper detected event is raised when the device is opened.  This setting allows you to decide whether or not to have the clear event automatically raised when the device closes.)", true)
    ...
    tiles (scale: 2) {
		...
		standardTile("acceleration", "device.tamper", width: 2, height: 2) {
			state("detected", label:'tamper', icon:"st.motion.acceleration.active", backgroundColor:"#ff0000")
			state("clear", label:'clear', icon:"st.motion.acceleration.inactive", backgroundColor:"#00ff00")
		}
		...
		main(["main"])
		details(["main","humidity","illuminance","motion","acceleration","battery","firmwareVersion","refresh","lastUpdate","lastActivity"])
	}
/*
    tiles(scale: 2) {

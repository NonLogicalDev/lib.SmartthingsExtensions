 ...
 */
 ...
 metadata {
	definition (name: "4-in-1-sensor-rev2", namespace: "zooz", author: "Robert Vandervoort") {
        ...
        // Firmware 16.9 & 17.9
        //fingerprint mfr:"027A", prod:"2021", model:"2101", deviceJoinName: "Zooz 4-in-1 Sensor V16+"

        // Firmware 5.1
        //fingerprint mfr:"0109", prod:"2021", model:"2101", deviceJoinName: "Zooz 4-in-1 Sensor V5"
		}
/*	simulator {
